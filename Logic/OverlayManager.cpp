...
Object createInterface() {
    Object interfac = ECS::createObject();
    interfac.AddComponent<UIBox>();
    interfac.GetComponent<UIBox>().direction = Direction::Absolute;
    interfac.GetComponent<UIBox>().widthFlags  = UISizeFlags::Fill;
    interfac.GetComponent<UIBox>().heightFlags = UISizeFlags::Fill;
    interfac.AddComponent<UIPopup>();

    Object point = ECS::createObject();
    point.AddComponent<UIImage>().color = Color(250, 250, 250);
    point.GetComponent<UIImage>().setSize(10, 10);
    point.GetComponent<UIImage>().anchor = Anchor::Center;
    point.GetComponent<UIImage>().pivot  = Anchor::Center;
    point.setParent(interfac);
...
void OverlayManager::Create() {
    ...
    createInterface().setParent(uiLayout);

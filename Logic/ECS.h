...
#define TRANSFORM_ARRAY_SIZE 1100
...
public:
	...
	static Object cloneObject(Object& source) {
		std::vector<char> buffer;
		SerializeEntity(source, buffer);
		Object copy = createObject();
		Span<char> data(buffer.data(), buffer.size());
		size_t offset = 0;
		DeserializeEntity(copy, data, offset);
		return copy;
	}
